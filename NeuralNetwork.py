...
class NeuralNetwork(object):
    ...
    def classify(dataFrame, alphaToUse, hiddenLayerSize, solverToUse, testValuePercent, isFixed, printResults):
        ...
        mlp = MLPClassifier(activation='logistic', alpha=0.001, batch_size='auto',
       beta_1=0.9, beta_2=0.999, early_stopping=False, epsilon=1e-08,
       hidden_layer_sizes=(48,),
       learning_rate_init=.001, max_iter=200, momentum=0.9,
       nesterovs_momentum=True, power_t=0.5, random_state=None,
       shuffle=True, solver='sgd', tol=0.0001, validation_fraction=0.1,
       verbose=False, warm_start=False) #Generate the Learning infrastructure
